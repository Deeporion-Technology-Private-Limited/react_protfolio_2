...
export default function CategoryGrid({gridWrapper}) {
  return (
    <div className={`w-full flex justify-center items-center mp-0 ${gridWrapper}`}>
      <div className="grid-container">
        {gridInfo.map((data) => (
          <div key={data.id} className="grid-element relative">
            <img src={data.imageName} alt={data.imageName.replace(" ","_")} />
            <div className="centered-text w-full image-heading z-99 mp-0">{data.title}</div>
